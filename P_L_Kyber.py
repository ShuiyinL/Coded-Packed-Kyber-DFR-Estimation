...
def Chernoff_bound(F, decoding_r_square,theta,packed_size):
...
if __name__ == "__main__":
    ...
    F, f, Cu = p2_cyclotomic_error_probability(ps_recommended,LloydCu,LloydCv)
    ...
    if packed_size in Encoder_List: 
        ...
        for i in (range(1, 10000000)): 
            ...
            tempt=Chernoff_bound(F, decoding_r_square, i*step_theta,packed_size)
