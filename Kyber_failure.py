...
def p2_cyclotomic_final_error_distribution(ps,LloydCu,LloydCv):
...
def p2_cyclotomic_error_probability(ps,LloydCu,LloydCv):
    F,Cu = p2_cyclotomic_final_error_distribution(ps, LloydCu,LloydCv)
